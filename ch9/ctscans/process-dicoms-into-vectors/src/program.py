...
parser.add_argument('--input_dir', type=str, default="/mnt/data/dicom",
                    help='Directory containing DICOM Images')
parser.add_argument('--bucket_name', type=str,
                    help='name of bucket to write output to.')
parser.add_argument('--output_file', type=str, default="s.csv",
...
np.savetxt("/tmp/s.csv", m['img3d'].reshape((-1,m['img_shape'][2])), delimiter=",")
